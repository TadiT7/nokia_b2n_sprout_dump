...
# -----------------------------------------------
WBG_CMD=`getprop persist.sys.wbg.bt`
WBG_TESTITEM=`getprop persist.sys.wbg.bt.testitem`
WBG_CHANNEL=`getprop persist.sys.wbg.bt.channel`
WBG_PAYLOAD=`getprop persist.sys.wbg.bt.payload`
WBG_POWER=`getprop persist.sys.wbg.bt.power`
WBG_SLOT=`getprop persist.sys.wbg.bt.slot`
WBG_GET_RX_DATA=`getprop persist.sys.wbg.bt.package`
WBG_GET_LE_PACKAGE=`getprop persist.sys.wbg.bt.lepackage`
WBG_SET_LE_PHY=`getprop persist.sys.wbg.bt.setlephy`
WBG_GET_LE_PHY=`getprop persist.sys.wbg.bt.getlephy`
WBG_GET_LE_PHY_MODULATION=`getprop persist.sys.wbg.bt.lemodulation`
...
function get_rx_data()
{
  ...
  # Save total bit value to persist.sys.wbg.bt.rxreport
  setprop persist.sys.wbg.bt.rxreport $TOTAL
}
...
function get_le_rx_data()
{
  ...
  setprop persist.sys.wbg.bt.lerxreport $NUMBER_OF_PACKETS
}
